...
int x = 0, y = 0;
int minX = INF, minY = INF;					// ����ĳ���ض���ͨ�����С/�� x ��������С/�� y ����
int maxX = 0, maxY = 0;
int blockSize = 0;							// ��ǰ��ͨ���С��С�� 100 �ĺ��Բ���
int minXBlocks[MAXW], minYBlocks[MAXW];		// ������ͨ�����С/�� x ��������С/�� y ����
int maxXBlocks[MAXW], maxYBlocks[MAXW];
int xyPtr = 0;								// ���������дָ��

int speedX[] = { 0, 1, 0, -1 };
int speedY[] = { -1, 0, 1, 0 };
char a[MAXH][MAXW];							// ͼ��ĸ���Ʒ��Ҫ��·��������ԭͼ��
ull extracted[65];							// ��ͨ����ȡ�����ת��Ϊ��ֵͼ��ʽ

void reduceNoise();							// ����

void dfs(int x, int y);						// ��һ����ͨ����б���
void extract(int index);					// ��ȡ�����ַ�
